...
Every release tag automatically triggers the CI/CD pipeline which builds and publishes ready-to-use binaries:
...
Download the pre-compiled extension from [GitHub Releases](https://github.com/mameyugo/JsonQ/releases/latest).
