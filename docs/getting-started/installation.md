...
wget https://github.com/mameyugo/JsonQ/releases/download/v0.3.2/php8.3-jsonq_0.3.2-1_amd64.deb

# Install
sudo dpkg -i php8.3-jsonq_0.3.2-1_amd64.deb
...
wget https://github.com/mameyugo/JsonQ/releases/download/v0.3.2/jsonq-v0.3.2-linux-x86_64-php8.3.so

# Copy to PHP extension directory
sudo cp jsonq-v0.3.2-linux-x86_64-php8.3.so $(php-config --extension-dir)/jsonq.so
