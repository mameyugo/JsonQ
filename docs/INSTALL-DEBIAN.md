...
```bash
# Download
wget https://github.com/mameyugo/JsonQ/releases/download/v0.1.0/php8.3-jsonq_0.1.0-1_amd64.deb

# Install
sudo dpkg -i php8.3-jsonq_0.1.0-1_amd64.deb
...
# Check version
php -r "echo 'JsonQ v' . jsonq_version() . PHP_EOL;"
